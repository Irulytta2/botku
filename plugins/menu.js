 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `𝐀𝐥𝐥 𝐌𝐞𝐧𝐮`, rowId: ".? all", description: ""},
	    {title: `𝐑𝐏𝐆 𝐌𝐞𝐧𝐮`, rowId: ".? rpg", description: ""},
	{title: `𝐄𝐱𝐩 𝐌𝐞𝐧𝐮`, rowId: ".? xp", description: ""},
	{title: `𝐆𝐚𝐦𝐞 𝐌𝐞𝐧𝐮`, rowId: ".? game", description: ""},
	{title: `𝐅𝐮𝐧 𝐌𝐞𝐧𝐮`, rowId: ".? fun", description: ""},
	{title: `𝐊𝐞𝐫𝐚𝐧𝐠 𝐌𝐞𝐧𝐮`, rowId: ".? kerangajaib", description: ""},
	{title: `𝐐𝐮𝐨𝐭𝐞𝐬 𝐌𝐞𝐧𝐮`, rowId: ".? quotes", description: ""},
	{title: `𝐀𝐧𝐢𝐦𝐞 𝐌𝐞𝐧𝐮`, rowId: ".? anime", description: ""},
	{title: `𝐍𝐬𝐟𝐰 𝐌𝐞𝐧𝐮`, rowId: ".? nsfw", description: ""},
	{title: `𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐌𝐞𝐧𝐮`, rowId: ".? premium", description: ""},
	{title: `𝐉𝐚𝐝𝐢𝐚𝐧 𝐌𝐞𝐧𝐮`, rowId: ".? jadian", description: ""},
	{title: `𝐀𝐧𝐨𝐧𝐲𝐦𝐨𝐮𝐬 𝐂𝐡𝐚𝐭`, rowId: ".? anonymous", description: ""},
	{title: `𝐈𝐧𝐭𝐞𝐫𝐧𝐞𝐭 𝐌𝐞𝐧𝐮`, rowId: ".? internet", description: ""},
  {title: `𝐁𝐞𝐫𝐢𝐭𝐚 𝐌𝐞𝐧𝐮`, rowId: ".? berita", description: ""},
	{title: `𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐞𝐫 𝐌𝐞𝐧𝐮`, rowId: ".? downloader", description: ""},
	{title: `𝐒𝐭𝐢𝐜𝐤𝐞𝐫 𝐌𝐞𝐧𝐮`, rowId: ".? stiker", description: ""},
	{title: `𝐍𝐮𝐥𝐢𝐬 𝐌𝐞𝐧𝐮`, rowId: ".? nulis", description: ""},
	{title: `𝐀𝐮𝐝𝐢𝐨 𝐌𝐞𝐧𝐮`, rowId: ".? audio", description: ""},
  {title: `𝐒𝐨𝐮𝐧𝐝 𝐌𝐞𝐧𝐮`, rowId: ".soundmenu", description: ""},
	{title: `𝐆𝐫𝐨𝐮𝐩 𝐌𝐞𝐧𝐮`, rowId: ".? group", description: ""},
	{title: `𝐂𝐨𝐧𝐯𝐞𝐫𝐭 𝐌𝐞𝐧𝐮`, rowId: ".? convert", description: ""},
	{title: `𝐃𝐚𝐭𝐚𝐛𝐚𝐬𝐞 𝐁𝐨𝐭`, rowId: ".? database", description: ""},
	{title: `𝐓𝐨𝐨𝐥𝐬 𝐌𝐞𝐧𝐮`, rowId: ".? tools", description: ""},
	]
    },{
	title: `INFO BOT`,
	rows: [
	    {title: `𝐒𝐩𝐞𝐞𝐝 𝐁𝐨𝐭`, rowId: ".speed", description: ""},
	    {title: `𝐌𝐲 𝐎𝐰𝐧𝐞𝐫`, rowId: ".owner", description: ""},
	    {title: `𝐒𝐜𝐫𝐢𝐩𝐭 𝐁𝐨𝐭`, rowId: ".sc", description: ``},
	{title: `𝐈𝐧𝐟𝐨 𝐁𝐨𝐭`, rowId: ".? info", description: ""},
	{title: `𝐑𝐮𝐧𝐭𝐢𝐦𝐞`, rowId: ".runtime", description: ""},
	    {title: `𝐒𝐞𝐰𝐚 𝐁𝐨𝐭`, rowId: ".sewa", description: ""},
	    {title: `𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐁𝐨𝐭`, rowId: ".donasi", description: ''},
	]
  },
]
